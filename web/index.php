 ...
 * Scripts
 */
define('REGISTRATION_VERIFICATION_SCRIPT', 'userRegisterFormHandler');
define('PRODUCT_SEARCH_RESULTS_SCRIPT', 'productSearchHandler');
